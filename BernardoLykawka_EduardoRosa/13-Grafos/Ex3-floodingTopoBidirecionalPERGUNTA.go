...
//
// não, o sistema não suporta, se cada nodo que recebe uma mensagem deve mandar uma resposta ao origem usando o mesmo protocolo de inundação, isso pode levar a um número infinito de mensagens sendo enviadas entre os nodos, causando sobrecarga e possível travamento do sistema.
